        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { title: 'Commercial Painting', desc: 'Professional retail, office, and multi-unit property solutions.', img: '/images/service-commercial.jpg', link: '/services#service-commercial' },
            ].map((service, idx) => (
